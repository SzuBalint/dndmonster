...
# Látszódik a két ábrán, hogy ahol a full adatot használtuk, azaz ott ahol nem a különbségét vettük az adatoknak, ott az adatok korlátozva voltak a 0 körül és kevesebb kapcsolatot láthatunk. Ez szerintünk azért van mert a játék hossza torzít amit így tudunk korrigálni.
...
# Érdekes lehet peldaul hogy mennyi aranyat koltottek, es ezzel mennyit tudtak az ellenfeleikre sebezni
...
# Erdekes lehet, hogy vajon a gyoztes csapat hatekonyabb-e az arany hasznalatban:
...
# Ranezesre nincs oriasi kulonbseg, de a gyoztes csapat ranezesre kevesbe szorodik, ezért mi úgy gondoljuk, hogy egy apró mértékben hatékonyabban fordították át az aranyukat sebzéssé.
...
# Nagyjabol stimmel, nincsen oriasi elteres, ezért biztosabbak lehetünk abban, hogy a mintánk nem torzít egyik irányba sem
