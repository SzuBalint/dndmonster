...
```{r}
ggplot(data, aes(x = goldEarned, y = totalDamageDealt)) + geom_line() + theme_minimal()

ggplot(data, aes(x = goldEarned, y = Mast)) + geom_line() + theme_minimal()

ggplot(data, aes(x = goldEarned, y = kills)) + geom_line() + theme_minimal()

# Valamiféle kapcsolatot láthatunk a változók között
```
